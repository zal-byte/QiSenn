...
public class UserProfile extends AppCompatActivity {
    ...
    private void userProfileParse(String result) throws JSONException {
        ...
        if (result.isEmpty()) {
            ...
            JSONArray jsonArray = jsonObject.getJSONArray(session.getWhoami());
    ...
    private void userProfile() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, userAction.api + "?request=userProfile&user=" + session.getWhoami()  + param, new Response.Listener<String>() {
            @Override
